export const meta = {
  ...
  category: "retrospect",
  excerpt_ko:
    "개발자로서 첫 2년간의 경험을 돌아보며 배운 점과 아쉬운 점, 그리고 나 자신에 대해 새롭게 깨달은 점들을 정리했습니다.",
  excerpt_en:
    "Looking back on my first 2 years as a developer, I've compiled what I learned, what I wish I had done differently, and new insights about myself.",
};
...
이 깨달음은 나의 마인드셋을 고정형에서 성장형으로 바꾸어 주었다. 이제는 내 안전지대를 벗어나 새로운 도전을 두려워하지 않고, 성공과 실패 모두에서 배우고 싶다. 해외 취업을 추진하는 것도 그 여정의 일부다.

## **아직도 헤매고 있는 부분은,**

많은 깨달음이 있었지만, 여전히 나 자신에 대해 혼란스러운 부분들이 있다.

나는 강한 열망과 이상주의적 성향을 가지고 있지만, 동시에 세세한 부분에 깊이 몰입하거나 지속적인 집중을 유지하는 데 어려움을 겪는다. 반복적인 작업은 금방 지루해진다.

하지만 나는 여전히 진화하고 있다고 믿는다. 더 다양한 경험을 통해 적절한 균형점을 찾을 수 있을 것이다. 앞으로도 계속된 탐험과 도전을 통해 내가 가고 싶은 방향에 대한 명확함을 얻을 수 있기를 바란다.
